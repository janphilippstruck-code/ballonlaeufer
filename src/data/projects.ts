...
export const projects: Project[] = [
  ...
  {
    title: "Ballon-Ultralauf – die Rückkehr",
    slug: "ballon-ultralauf",
    shortDescription: "Zurück zu den Wurzeln.",
    longDescription: [
      "Mit dem Ballon-Ultralauf hat 2018 meine Geschichte als Veranstalter angefangen. Nach mehreren Jahren Pause soll das Format zurückkommen – diesmal mit all der Erfahrung, Technik und Organisation, die seit dem ersten Lauf dazugekommen sind.",
    ...
    status: "IN PLANUNG",
    year: "2027",
    image: img.ballonUltraKeyvisual,
    imageAlt: "Keyvisual der Neuauflage des Ballon-Ultralaufs",
