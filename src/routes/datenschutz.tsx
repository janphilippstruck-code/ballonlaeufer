    ...
    <div className="container-bl py-16 md:py-24">
      <div className="max-w-3xl">
        ...
        <p className="prose-bl mt-8">
          Diese Website kommt ohne Tracking, ohne Newsletter-System, ohne eingebettete Karten und
          ohne extern geladene Schriften aus. Eine Kontaktaufnahme erfolgt per E-Mail an{" "}
        ...
        <div className="mt-10 rounded-xl border border-dashed border-brand/60 bg-surface p-7">
          ...
          <p className="prose-bl mt-3">
            Rechtlicher Inhalt wird vor Veröffentlichung ergänzt. Hier gehört die vollständige
